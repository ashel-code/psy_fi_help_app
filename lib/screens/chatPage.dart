...
import 'package:psy_fi_help_app/models/chatUsersModel.dart';
import 'package:psy_fi_help_app/widgets/conservationList.dart';
              ...
              SafeArea(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text('Conservations', style: TextStyle(fontSize: 28,
